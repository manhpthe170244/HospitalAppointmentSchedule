        ...
        public MappingProfile()
        {
          ...
          CreateMap<Reservation, ReservationDto>()
                ...
                .ForMember(dest => dest.SlotTime, opt => opt.MapFrom(src => 
                    $"{src.DoctorSchedules.FirstOrDefault().Slot.SlotStartTime:hh\\:mm} - {src.DoctorSchedules.FirstOrDefault().Slot.SlotEndTime:hh\\:mm}")) // Sửa định dạng
            ...
            CreateMap<Patient, PatientDto>()
                ...
                .ForMember(dest => dest.DateOfBirth, opt => opt.MapFrom(src => src.PatientNavigation.Dob))
               ...
               .ForMember(dest => dest.IsVerify, opt => opt.MapFrom(src => src.PatientNavigation.IsVerify)); // Assuming IsVerify is directly in PatientNavigation
            // Payment mappings
